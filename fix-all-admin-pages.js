/**
 * Fix all admin page.jsx files with JSX syntax errors
 */
...
const ADMIN_PAGE_FILES = [
  ...
  'app/admin/header/page.jsx',
  'app/admin/footer/page.jsx',
  'app/admin/menus/page.jsx',
  'app/admin/redirects/page.jsx',
  'app/admin/sitemap/page.jsx',
  'app/admin/robots/page.jsx',
  'app/admin/import-export/page.jsx',
...
function fixAllAdminPages() {
  console.log('Fixing JSX syntax in all admin page.jsx files...')
  console.log('='.repeat(60))
  
  let fixedCount = 0
  let errorCount = 0
  
  for (const filePath of ADMIN_PAGE_FILES) {
    try {
