/**
 * Comprehensive API endpoint audit for CMS
 */
...
const API_ENDPOINTS = [
  ...
  { method: 'GET', path: '/api/cms/media', description: 'Get media items' },
  { method: 'GET', path: '/api/cms/sections', description: 'Get sections' },
  { method: 'GET', path: '/api/cms/testimonials', description: 'Get testimonials' },
  { method: 'GET', path: '/api/cms/faqs', description: 'Get FAQs' },
  { method: 'GET', path: '/api/cms/courses', description: 'Get courses' },
  { method: 'GET', path: '/api/cms/tools', description: 'Get tools' },
