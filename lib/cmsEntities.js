...
export const CMS_ENTITIES = {
  ...
  tools_extended: {
    ...
    visibilityField: 'is_active',
    allowedFields: ['name', 'slug', 'description', 'category', 'logo_url', 'brand_color', 'website_url', 'is_active'],
    slugField: 'slug',
  },
  resources: {
    table: 'resources',
    orderBy: [{ column: 'order_index', ascending: true }, { column: 'created_at', ascending: false }],
    visibilityField: 'is_active',
    allowedFields: [
      'title',
      'description',
  ...
  course_details: {
    ...
    orderBy: [{ column: 'order_index', ascending: true }, { column: 'updated_at', ascending: false }],
    allowedFields: ['course_id', 'section_title', 'content', 'order_index'],
  },
  testimonials: {
    table: 'testimonials',
    orderBy: [{ column: 'order_index', ascending: true }, { column: 'updated_at', ascending: false }],
  ...
  companies: {
    table: 'companies',
    orderBy: [{ column: 'created_at', ascending: false }],
    allowedFields: ['company_name', 'logo'],
  },
  internships: {
    table: 'internships',
    orderBy: [{ column: 'created_at', ascending: false }],
  ...
  lms_modules: {
    table: 'lms_modules',
    orderBy: [{ column: 'order_index', ascending: true }, { column: 'created_at', ascending: false }],
    allowedFields: ['course_id', 'title', 'description', 'order_index'],
  },
  lms_lessons: {
    table: 'lms_lessons',
    orderBy: [{ column: 'order_index', ascending: true }, { column: 'created_at', ascending: false }],
    allowedFields: ['module_id', 'title', 'content', 'file_url', 'order_index'],
  },
  placements: {
    table: 'placements',
    orderBy: [{ column: 'created_at', ascending: false }],
  ...
  navigation_menus: {
    table: 'menus',
    orderBy: [{ column: 'menu_location', ascending: true }, { column: 'order_index', ascending: true }],
    visibilityField: 'is_active',
    allowedFields: ['menu_location', 'title', 'url', 'parent_id', 'target', 'order_index', 'is_active'],
  },
  reusable_blocks: {
