...
-- Insert default homepage settings (idempotent: only seed when the table is genuinely empty)
insert into public.homepage_settings (section_order)
select '["hero", "about", "stats", "courses", "placements", "testimonials", "gallery", "faq", "contact", "footer"]'::jsonb
