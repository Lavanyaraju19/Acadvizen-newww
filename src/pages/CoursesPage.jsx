    ...
    <div className="min-h-screen">
      <Section className="pt-10 md:pt-14 pb-6 md:pb-10">
        <Container>
          ...
          >
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-slate-50">Courses</h1>
      ...
      <Section className="py-6 md:py-10">
        <Container>
          {loading ? (
            ...
            <Surface className="p-10 text-center text-slate-400">No courses available.</Surface>
          ) : (
