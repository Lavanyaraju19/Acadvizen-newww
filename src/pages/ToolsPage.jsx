    ...
    <div className="min-h-screen">
      <Section className="pt-10 md:pt-14 pb-6 md:pb-10">
        <Container>
          ...
          >
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-slate-50">Tool Library</h1>
        ...
        <Container>
          ...
          <div className="mt-6 md:mt-8">
            {loading ? (
              ...
              <Surface className="p-10 text-center text-slate-400">No tools found.</Surface>
            ) : (
