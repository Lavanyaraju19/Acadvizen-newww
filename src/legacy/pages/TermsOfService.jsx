...
const termsParagraphs = [
  ...
  "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.acadvizen.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
  "The Platform is owned by ACADVIZEN, a company incorporated under the Companies Act, 1956 with its registered office at No 647-35-29, 11th Main Road, 5th Block, Jayanagar, Bengaluru, Bengaluru Urban, Karnataka, 560078 (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').",
    ...
    <div className="min-h-screen">
      <Section className="pt-10 md:pt-14 pb-6 md:pb-10">
        <Container className="max-w-5xl">
          <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-slate-50 text-center">Terms of Service</h1>
        </Container>
      </Section>
      ...
      <Section className="pb-12 md:pb-16">
        <Container className="max-w-5xl">
          <Surface className="p-6 md:p-8">
            <div className="space-y-4 text-sm md:text-base leading-7 text-slate-300">
              {termsParagraphs.map((paragraph, idx) => (
                <p key={idx}>{paragraph}</p>
              ))}
            </div>
            <div className="mt-10 rounded-xl border border-rose-400/30 bg-rose-500/10 p-4">
              <h2 className="text-lg font-semibold text-rose-200">Refund and Cancellation Policy</h2>
              <p className="mt-2 text-sm md:text-base font-semibold text-rose-100">
                ALL PAYMENTS ARE FINAL. NO REFUND/CANCELLATION ARE ENTERTAINED
              </p>
            </div>
          </Surface>
        </Container>
